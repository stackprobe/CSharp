...
namespace Charlotte
{
	public class Setting
	{
		...
		public Color RemarksTextDefaultForeColor = Color.FromArgb(0, 48, 0);
		...
		private void Load_Main()
		{
			...
			this.RemarksTextDefaultForeColor = Color.FromArgb(int.Parse(lines[c++]));
		...
		public void Save()
		{
			...
			lines.Add("" + this.RemarksTextDefaultForeColor.ToArgb());
