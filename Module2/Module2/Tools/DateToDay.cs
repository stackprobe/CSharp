	...
	public class DateToDay
	{
		public static int ToDay(int date)
		{
			if (date < 10000101 || 99991231 < date)
				throw new ArgumentOutOfRangeException("date: " + date);
			...
			if (
				...
				throw new ArgumentOutOfRangeException("date: " + date + ", y: " + y + ", m: " + m + ", d: " + d);
		...
		public static int ToDate(int day)
		{
			...
			if (
				...
				throw new ArgumentOutOfRangeException("day: " + day + ", y: " + y + ", m: " + m + ", d: " + d);
