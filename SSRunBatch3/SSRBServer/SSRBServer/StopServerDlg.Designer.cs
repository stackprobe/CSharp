namespace Charlotte
{
	partial class StopServerDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.BtnAbandon.Location = new System.Drawing.Point(188, 48);
			this.BtnAbandon.Name = "BtnAbandon";
			this.BtnAbandon.Size = new System.Drawing.Size(340, 40);
			this.BtnAbandon.TabIndex = 1;
			this.BtnAbandon.Text = "現在実行中のバッチファイルを強制終了する(&A)";
			...
			this.label1.Text = "サーバーの終了を待っています...";
			// 
			// MainTimer
			// 
			...
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.StopServerDlg_FormClosing);
